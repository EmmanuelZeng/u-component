...
const Text = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, element === "p" && /*#__PURE__*/React__default["default"].createElement("p", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "span" && /*#__PURE__*/React__default["default"].createElement("span", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "h1" && /*#__PURE__*/React__default["default"].createElement("h1", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "h2" && /*#__PURE__*/React__default["default"].createElement("h2", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "h3" && /*#__PURE__*/React__default["default"].createElement("h3", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "h4" && /*#__PURE__*/React__default["default"].createElement("h4", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "h5" && /*#__PURE__*/React__default["default"].createElement("h5", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children), element === "h6" && /*#__PURE__*/React__default["default"].createElement("h6", {
    className: `${className} text-${type} text-${align} text-${size} font-${fontWeight} ${whiteSpace}`
  }, children));
};
Text.propTypes = {
...
const Avatar = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    onClick: onClick
  }, children ? children : src ? /*#__PURE__*/React__default["default"].createElement("img", {
    className: `inline-block w-full h-full`,
    alt: alt,
    src: src
  }) : /*#__PURE__*/React__default["default"].createElement(UserIcon, null));
};
Avatar.propTypes = {
  /**
...
const Checkbox = ({
  ...
  }, otherInputProps)), /*#__PURE__*/React__default["default"].createElement("label", _extends$1({
    htmlFor: id ? id : "input-radio",
...
const TextArea = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    className: "text-danger"
  }, "*") : ""), /*#__PURE__*/React__default["default"].createElement("textarea", _extends$1({}, inputProps, {
    value: value,
    onChange: onChange,
    required: required,
    placeholder: placeholder,
